...
<?php if ($embed_code): ?>
  <li><?php /*<a class="embed" href="#embed-code">*/ ?><label class="embed" for="embed-code"><span><?=t('Embed code') ?></span></label></a>
  <textarea id="embed-code" class="embed-code" readonly title="<?=$embed_method ?>"><?=str_replace('<','&lt;', $embed_code) ?></textarea>
