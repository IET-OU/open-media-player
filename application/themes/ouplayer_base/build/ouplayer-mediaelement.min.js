...
(g=0<a.videoWidth?a.videoWidth:null!==c.getAttribute("width")?c.getAttribute("width"):a.defaultVideoWidth,h=0<a.videoHeight?a.videoHeight:null!==c.getAttribute("height")?c.getAttribute("height"):a.defaultVideoHeight,g=mejs.Utility.encodeUrl(g),h=mejs.Utility.encodeUrl(h)):a.enablePluginDebug&&(g=320,h=240);k.success=a.success;mejs.MediaPluginBridge.registerPluginElement(j,k,c);l.className="me-plugin";l.id=j+"_container";b.isVideo?c.parentNode.insertBefore(l,c):document.body.insertBefore(l,document.body.childNodes[0]);
d=["id="+j,"isvideo="+(b.isVideo?"true":"false"),"autoplay="+(d?"true":"false"),"preload="+e,"width="+g,"startvolume="+a.startVolume,"timerrate="+a.timerRate,"height="+h];null!==b.url&&("flash"==b.method?d.push("file="+mejs.Utility.encodeUrl(b.url)):d.push("file="+b.url));a.enablePluginDebug&&d.push("debug=true");a.enablePluginSmoothing&&d.push("smoothing=true");f&&d.push("controls=true");a.pluginVars&&(d=d.concat(a.pluginVars));switch(b.method){case "silverlight":l.innerHTML='<object data="data:application/x-silverlight-2," type="application/x-silverlight-2" id="'+
j+'" name="'+j+'" width="'+g+'" height="'+h+'"><param name="initParams" value="'+d.join(",")+'" /><param name="windowless" value="true" /><param name="background" value="black" /><param name="minRuntimeVersion" value="3.0.0.0" /><param name="autoUpgrade" value="true" /><param name="source" value="'+a.pluginPath+a.silverlightName+'" /></object>';break;case "flash":mejs.MediaFeatures.isIE?(b=document.createElement("div"),l.appendChild(b),b.outerHTML='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="//download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab" id="'+
j+'" width="'+g+'" height="'+h+'"><param name="movie" value="'+a.pluginPath+a.flashName+"?x="+new Date+'" /><param name="flashvars" value="'+d.join("&amp;")+'" /><param name="quality" value="high" /><param name="bgcolor" value="#000000" /><param name="wmode" value="transparent" /><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="true" /></object>'):l.innerHTML='<embed id="'+j+'" name="'+j+'" play="true" loop="false" quality="high" bgcolor="#000000" wmode="transparent" allowScriptAccess="always" allowFullScreen="true" type="application/x-shockwave-flash" pluginspage="//www.macromedia.com/go/getflashplayer" src="'+
a.pluginPath+a.flashName+'" flashvars="'+d.join("&")+'" width="'+g+'" height="'+h+'"></embed>';break;case "youtube":a=b.url.substr(b.url.lastIndexOf("=")+1);youtubeSettings={container:l,containerId:l.id,pluginMediaElement:k,pluginId:j,videoId:a,height:h,width:g};mejs.PluginDetector.hasPluginVersion("flash",[10,0,0])?mejs.YouTubeApi.createFlash(youtubeSettings):mejs.YouTubeApi.enqueueIframe(youtubeSettings);break;case "vimeo":k.vimeoid=b.url.substr(b.url.lastIndexOf("/")+1),l.innerHTML='<object width="'+
g+'" height="'+h+'"><param name="allowfullscreen" value="true" /><param name="allowscriptaccess" value="always" /><param name="flashvars" value="api=1" /><param name="movie" value="http://vimeo.com/moogaloop.swf?clip_id='+k.vimeoid+'&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=00adef&amp;fullscreen=1&amp;autoplay=0&amp;loop=0" /><embed src="//vimeo.com/moogaloop.swf?api=1&amp;clip_id='+k.vimeoid+'&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=00adef&amp;fullscreen=1&amp;autoplay=0&amp;loop=0" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="'+
g+'" height="'+h+'"></embed></object>'}c.style.display="none";return k},updateNative:function(b,a){var c=b.htmlMediaElement,d;for(d in mejs.HtmlMediaElement)c[d]=mejs.HtmlMediaElement[d];a.success(c,c);return c}};
...
!a.AndroidUseNativeControls)a.$media.removeAttr("controls"),a.id="mep_"+mejs.mepIndex++,a.container=b('<div id="'+a.id+'" class="mejs-container"><div class="mejs-inner"><div class="mejs-mediaelement"></div><div class="mejs-layers"></div><div class="mejs-controls"></div><div class="mejs-clear"></div></div></div>').addClass(a.$media[0].className).insertBefore(a.$media),a.container.addClass((c.isAndroid?"mejs-android ":"")+(c.isiOS?"mejs-ios ":"")+(c.isiPad?"mejs-ipad ":"")+(c.isiPhone?"mejs-iphone ":
"")+(a.isVideo?"mejs-video ":"mejs-audio ")),c.isiOS?(c=a.$media.clone(),a.container.find(".mejs-mediaelement").append(c),a.$media.remove(),a.$node=a.$media=c,a.node=a.media=c[0]):a.container.find(".mejs-mediaelement").append(a.$media),a.controls=a.container.find(".mejs-controls"),a.layers=a.container.find(".mejs-layers"),c=a.isVideo?"video":"audio",e=c.substring(0,1).toUpperCase()+c.substring(1),a.width=0<a.options[c+"Width"]||-1<a.options[c+"Width"].toString().indexOf("%")?a.options[c+"Width"]:
""!==a.media.style.width&&null!==a.media.style.width?a.media.style.width:null!==a.media.getAttribute("width")?a.$media.attr("width"):a.options["default"+e+"Width"],a.height=0<a.options[c+"Height"]||-1<a.options[c+"Height"].toString().indexOf("%")?a.options[c+"Height"]:""!==a.media.style.height&&null!==a.media.style.height?a.media.style.height:null!==a.$media[0].getAttribute("height")?a.$media.attr("height"):a.options["default"+e+"Height"],a.setPlayerSize(a.width,a.height),d.pluginWidth=a.height,d.pluginHeight=
a.width;mejs.MediaElement(a.$media[0],d)},showControls:function(a){var b=this;b.controlsAreVisible||("undefined"==typeof a||a?(b.controls.css("visibility","visible").stop(!0,!0).fadeIn(200,function(){b.controlsAreVisible=!0}),b.container.find(".mejs-control").css("visibility","visible").stop(!0,!0).fadeIn(200,function(){b.controlsAreVisible=!0})):(b.controls.css("visibility","visible").css("display","block"),b.container.find(".mejs-control").css("visibility","visible").css("display","block"),b.controlsAreVisible=
...
d.hideControls(),d.options.enableAutosize&&d.media.addEventListener("loadedmetadata",function(a){if(d.options.videoHeight<=0&&d.domNode.getAttribute("height")===null&&!isNaN(a.target.videoHeight)){d.setPlayerSize(a.target.videoWidth,a.target.videoHeight);d.setControlsSize();d.media.setVideoSize(a.target.videoWidth,a.target.videoHeight)}},!1));a.addEventListener("play",function(){for(var a=0,b=mejs.players.length;a<b;a++){var c=mejs.players[a];c.id!=d.id&&(d.options.pauseOtherPlayers&&!c.paused&&!c.ended)&&
c.pause();c.hasFocus=false}d.hasFocus=true},!1);d.media.addEventListener("ended",function(){try{d.media.setCurrentTime(0)}catch(a){}d.media.pause();d.setProgressRail&&d.setProgressRail();d.setCurrentRail&&d.setCurrentRail();d.options.loop?d.media.play():!d.options.alwaysShowControls&&d.controlsEnabled&&d.showControls()},!1);d.media.addEventListener("loadedmetadata",function(){d.updateDuration&&d.updateDuration();d.updateCurrent&&d.updateCurrent();if(!d.isFullScreen){d.setPlayerSize(d.width,d.height);
d.setControlsSize()}},!1);setTimeout(function(){d.setPlayerSize(d.width,d.height);d.setControlsSize()},50);b(window).resize(function(){d.isFullScreen||mejs.MediaFeatures.hasTrueNativeFullScreen&&document.webkitIsFullScreen||d.setPlayerSize(d.width,d.height);d.setControlsSize()});"youtube"==d.media.pluginType&&d.container.find(".mejs-overlay-play").hide()}f&&"native"==a.pluginType&&(a.load(),a.play());if(d.options.success)if("string"==typeof d.options.success)window[d.options.success](d.media,d.domNode,
d);else d.options.success(d.media,d.domNode,d)}},handleError:function(a){this.controls.hide();this.options.error&&this.options.error(a)},setPlayerSize:function(a,c){"undefined"!=typeof a&&(this.width=a);"undefined"!=typeof c&&(this.height=c);if(0<this.height.toString().indexOf("%")){var d=this.media.videoWidth&&0<this.media.videoWidth?this.media.videoWidth:this.options.defaultVideoWidth,e=this.media.videoHeight&&0<this.media.videoHeight?this.media.videoHeight:this.options.defaultVideoHeight,f=this.container.parent().width(),
d=parseInt(f*e/d,10);"body"===this.container.parent()[0].tagName.toLowerCase()&&(f=b(window).width(),d=b(window).height());0!=d&&(this.container.width(f).height(d),this.$media.width("100%").height("100%"),this.container.find("object, embed, iframe").width("100%").height("100%"),this.isVideo&&this.media.setVideoSize&&this.media.setVideoSize(f,d),this.layers.children(".mejs-layer").width("100%").height("100%"))}else this.container.width(this.width).height(this.height),this.layers.children(".mejs-layer").width(this.width).height(this.height)},
...
c,d,e){if(a.isVideo){var f=b('<div class="mejs-overlay mejs-layer"><div class="mejs-overlay-loading"><span></span></div></div>').hide().appendTo(d),g=b('<div class="mejs-overlay mejs-layer"><div class="mejs-overlay-error"></div></div>').hide().appendTo(d),h=b('<div class="mejs-overlay mejs-layer mejs-overlay-play"><div class="mejs-overlay-button"></div></div>').appendTo(d).click(function(){e.paused?e.play():e.pause()});e.addEventListener("play",function(){h.hide();f.hide();c.find(".mejs-time-buffering").hide();
g.hide()},!1);e.addEventListener("playing",function(){h.hide();f.hide();c.find(".mejs-time-buffering").hide();g.hide()},!1);e.addEventListener("seeking",function(){f.show();c.find(".mejs-time-buffering").show()},!1);e.addEventListener("seeked",function(){f.hide();c.find(".mejs-time-buffering").hide()},!1);e.addEventListener("pause",function(){mejs.MediaFeatures.isiPhone||h.show()},!1);e.addEventListener("waiting",function(){f.show();c.find(".mejs-time-buffering").show()},!1);e.addEventListener("loadeddata",
function(){f.show();c.find(".mejs-time-buffering").show()},!1);e.addEventListener("canplay",function(){f.hide();c.find(".mejs-time-buffering").hide()},!1);e.addEventListener("error",function(){f.hide();c.find(".mejs-time-buffering").hide();g.show();g.find("mejs-overlay-error").html("Error loading this resource")},!1)}},buildkeyboard:function(a,c,d,e){b(document).keydown(function(b){if(a.hasFocus&&a.options.enableKeyboard)for(var c=0,d=a.options.keyActions.length;c<d;c++)for(var j=a.options.keyActions[c],
k=0,l=j.keys.length;k<l;k++)if(b.keyCode==j.keys[k])return b.preventDefault(),j.action(a,e,b.keyCode),!1;return!0});b(document).click(function(c){0==b(c.target).closest(".mejs-container").length&&(a.hasFocus=!1)})},findTracks:function(){var a=this,c=a.$media.find("track");a.tracks=[];c.each(function(c,e){e=b(e);a.tracks.push({srclang:e.attr("srclang").toLowerCase(),src:e.attr("src"),kind:e.attr("kind"),label:e.attr("label")||"",entries:[],isLoaded:!1})})},changeSkin:function(a){this.container[0].className=
...
a.isFullScreen?a.exitFullScreen():a.enterFullScreen()});else{var h=null;var c=document.createElement("x"),d=document.documentElement,j=window.getComputedStyle;"pointerEvents"in c.style?(c.style.pointerEvents="auto",c.style.pointerEvents="x",d.appendChild(c),j=j&&"auto"===j(c,"").pointerEvents,d.removeChild(c),c=!!j):c=!1;if(c&&!mejs.MediaFeatures.isOpera){var k=!1,l=function(){if(k){m.hide();n.hide();o.hide();g.css("pointer-events","");f.controls.css("pointer-events","");k=false}},m=b('<div class="mejs-fullscreen-hover" />').appendTo(f.container).mouseover(l),
n=b('<div class="mejs-fullscreen-hover"  />').appendTo(f.container).mouseover(l),o=b('<div class="mejs-fullscreen-hover"  />').appendTo(f.container).mouseover(l),p=function(){var a={position:"absolute",top:0,left:0};m.css(a);n.css(a);o.css(a);m.width(f.container.width()).height(f.container.height()-f.controls.height());a=g.offset().left-f.container.offset().left;fullScreenBtnWidth=g.outerWidth(true);n.width(a).height(f.controls.height()).css({top:f.container.height()-f.controls.height()});o.width(f.container.width()-
a-fullScreenBtnWidth).height(f.controls.height()).css({top:f.container.height()-f.controls.height(),left:a+fullScreenBtnWidth})};b(document).resize(function(){p()});g.mouseover(function(){if(!f.isFullScreen){var b=g.offset(),c=a.container.offset();e.positionFullscreenButton(b.left-c.left,b.top-c.top,false);g.css("pointer-events","none");f.controls.css("pointer-events","none");m.show();o.show();n.show();p();k=true}});e.addEventListener("fullscreenchange",function(){l()})}else g.mouseover(function(){if(h!==
null){clearTimeout(h);delete h}var b=g.offset(),c=a.container.offset();e.positionFullscreenButton(b.left-c.left,b.top-c.top,true)}).mouseout(function(){if(h!==null){clearTimeout(h);delete h}h=setTimeout(function(){e.hideFullscreenButton()},1500)})}a.fullscreenBtn=g;b(document).bind("keydown",function(b){(mejs.MediaFeatures.hasTrueNativeFullScreen&&mejs.MediaFeatures.isFullScreen()||f.isFullScreen)&&b.keyCode==27&&a.exitFullScreen()})}},enterFullScreen:function(){var a=this;if(!("native"!==a.media.pluginType&&
...
|
*/
(function(b){b.log=function(a){"undefined"!==typeof console&&console.log(a)};b.oup_fire=function(a,b){var d,e=document;e.createEvent?(d=e.createEvent("Event"),d.initEvent(b,!0,!0)):(d=e.createEventObject(),d.eventType="on"+b);e.createEvent?a.dispatchEvent(d):a.fireEvent&&a.fireEvent(d.eventType,d)};"undefined"===typeof b.ender?b.log("Using jquery."):b.log("Using ender.");b.extend(mejs.MepDefaults,{controlsText:"Player controls",loadingText:"loading",currentText:"Current time",durationText:"Total time"});
b.extend(MediaElementPlayer.prototype,{buildoup_shim:function(a,b){var d=this.options,e=b.find(".mejs-currenttime"),f=b.find(".mejs-duration");b.attr("aria-label",d.controlsText).attr("role","toolbar").attr("lang",d.startLanguage);e.attr("aria-label",d.currentText);f.attr("aria-label",d.durationText);b.group=function(){return"undefined"===typeof this.oup_group?this:this.oup_group}}});b(document).ready(function(){function a(){450>=c.width()?c.addClass(d).removeClass(e).removeClass(f):720<=c.width()?
c.removeClass(d).removeClass(e).addClass(f):c.removeClass(d).addClass(e).removeClass(f);b.log(">> check_size, width px: "+c.width())}var c=b("body"),d="width-small",e="width-medium",f="width-large";b(window).resize(a);a()})})(mejs.$);(function(b){b.extend(mejs.MepDefaults,{showtracksText:"Show captions",hidetracksText:"Hide captions"});b.extend(MediaElementPlayer.prototype,{buildoup_tracks_shim:function(a,c){var d=this.options,e=null,f=c.find(".mejs-captions-button button");b.log("Tracks..");b.log(a.tracks[0]);b.log(f);"undefined"!==typeof a.tracks[0]&&(e=a.tracks[0],f.click(function(){null==a.selectedTrack?(a.selectedTrack=e,a.captions.attr("lang",e.srclang),a.displayCaptions(),f.attr("title",d.hidetracksText)):(a.captions.hide(),
e=a.selectedTrack,a.selectedTrack=null,f.attr("title",d.showtracksText))}))}})})(mejs.$);(function(b){b.extend(mejs.MepDefaults,{playText:"Play",pauseText:"Pause"});b.extend(MediaElementPlayer.prototype,{buildoup_playpause:function(a,c,d,e){var f=this.options,g=b('<div class="mejs-button mejs-playpause-button mejs-play" ><button type="button" aria-controls="'+this.id+'" title="'+f.playText+'"></button></div>').appendTo(c).click(function(a){a.preventDefault();e.paused?e.play():e.pause();return!1}),h=g.find("button");e.addEventListener("play",function(){g.removeClass("mejs-play").addClass("mejs-pause");
...
c.find(".mejs-time-buffering").hide();var f=this.options,g=c.find(".mejs-time-total"),d=c.find(".mejs-time-loaded"),h=c.find(".mejs-time-current"),j=c.find(".mejs-time-handle"),k=c.find(".mejs-time-float"),l=c.find(".mejs-time-float-current"),m=function(a){var a=a.pageX,b=g.offset(),c=g.outerWidth(),d=0,d=0,f=a-b.left;a>b.left&&(a<=c+b.left&&e.duration)&&(d=(a-b.left)/c,d=0.02>=d?0:d*e.duration,n&&e.setCurrentTime(d),mejs.MediaFeatures.hasTouch||(k.css("left",f),l.html(mejs.Utility.secondsToTimeCode(d)),
k.show()))},n=!1;handleKeyMove=function(a,b){-1==a?(e.pause(),e.setCurrentTime(e.duration-2)):e.setCurrentTime(a);b.preventDefault()};updateSlider=function(){var a=e.currentTime,b=mejs.Utility.secondsToTimeCode(a);j.attr({"aria-valuenow":a,"aria-valuetext":b,"aria-valuemin":0,"aria-valuemax":e.duration,"aria-label":f.progressText,tabindex:0,role:"slider"})};j.bind("keydown",function(a){b.log(a);if(35<=a.keyCode&&39>=a.keyCode)try{var c=e.currentTime;if("undefined"!=typeof a.metaKey&&a.metaKey)37==
a.keyCode?handleKeyMove(0,a):39==a.keyCode&&handleKeyMove(-1,a);else switch(a.keyCode){case 37:handleKeyMove(c-f.seekSeconds,a);break;case 39:handleKeyMove(c+f.seekSeconds,a);break;case 36:handleKeyMove(0,a);break;case 35:handleKeyMove(-1,a)}}catch(d){b.log(d)}});g.bind("mousedown",function(a){if(1===a.which)return n=!0,m(a),b(document).bind("mousemove.dur",function(a){m(a)}).bind("mouseup.dur",function(){n=!1;k.hide();b(document).unbind(".dur")}),!1}).bind("mouseenter",function(){b(document).bind("mousemove.dur",
function(a){m(a)});mejs.MediaFeatures.hasTouch||k.show()}).bind("mouseleave",function(){n||(b(document).unbind(".dur"),k.hide())});e.addEventListener("progress",function(b){a.setProgressRail(b);a.setCurrentRail(b)},!1);e.addEventListener("timeupdate",function(b){a.setProgressRail(b);a.setCurrentRail(b);updateSlider(b)},!1);this.loaded=d;this.total=g;this.current=h;this.handle=j},setProgressRail:function(a){var b=void 0!=a?a.target:this.media,d=null;b&&b.buffered&&0<b.buffered.length&&b.buffered.end&&
